...
struct Sense {
    ...
    void modifyHighlights() {
        ...
        { //player highlight - visible 
            ...
            const GlowMode oldGlowMode = mem::Read<GlowMode>(highlightSettingsPtr + (highlightSize * highlightId) + 0);
            ...
            const Color oldColor = mem::Read<Color>(highlightSettingsPtr + (highlightSize * highlightId) + 4);
